...
class Centaur {
	...
	public function __construct() {
	    ...
	    if(wp_get_environment_type() === 'production') {
            // for live
            $this->email_recipients = 'mviator@duvine.com,gkidera@duvine.com,operations@duvine.com';
            $this->critical_email_recipients = 'mviator@duvine.com,gkidera@duvine.com,operations@duvine.com';
        } else {
            // for testing
            $this->email_recipients = 'mviator@duvine.com,gkidera@duvine.com,operations@duvine.com';
            $this->critical_email_recipients = 'mviator@duvine.com,gkidera@duvine.com,operations@duvine.com';
	...
	public function send_log_errors($error_level) {
		...
		$subject = 'Duvine Data Sync Log: '.$error_level;
		$body = nl2br($log_text);
	...
	public function get_tour_info_from_api( $tour_num, $tour_code ) {
		...
		try {
			...
			$response = $tour_client->send($request, ['timeout' => 20]);
