;(function($, w, doc){
  ...
  */
  ...
  Nav.createSmallView = function( parentMenu, subMenu ) {
    ...
    parentMenu.find('a').first().after('<a href="#" aria-controls="' + slug + '" class="ui-toggle-button" data-text="close">open</a>');
    
    parentMenu.find('a').first().on('click', function(event) {
      event.preventDefault();
      button = parentMenu.find('.ui-toggle-button').first();
