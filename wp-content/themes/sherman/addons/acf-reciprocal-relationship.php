...
add_filter('acf/update_value/key=field_595a7471753ef', 'acf_reciprocal_relationship_bikes', 10, 3);
add_filter('acf/update_value/key=field_596d15bc5a7dc', 'acf_reciprocal_relationship_bikes', 10, 3);
function acf_reciprocal_relationship_bikes($value, $post_id, $field) {
    ...
    $key_a = 'field_595a7471753ef';
    // the field key of the other side of the relationship
    // as noted above, this can be the same as $key_a
    $key_b = 'field_596d15bc5a7dc';
    

    return acf_util_reciprocate_relationship_fields( $key_a, $key_b, $value, $post_id, $field );

} // end function acf_reciprocal_relationship_bikes
...
add_filter('acf/update_value/key=field_596d258ddcebb', 'acf_reciprocal_relationship_people', 10, 3);
add_filter('acf/update_value/key=field_596d15bc5a7dc', 'acf_reciprocal_relationship_people', 10, 3);

function acf_reciprocal_relationship_people($value, $post_id, $field) {
...
} // end function acf_reciprocal_relationship_people
...
// add the filter for your relationship field
add_filter('acf/update_value/key=field_5936fab2baaf4', 'acf_reciprocal_relationship_press', 10, 3);
// if you are using 2 relationship fields on different post types
// add second filter for that fields as well
add_filter('acf/update_value/key=field_596d15bc5a7dc', 'acf_reciprocal_relationship_press', 10, 3);

function acf_reciprocal_relationship_press($value, $post_id, $field) {
...
} // end function acf_reciprocal_relationship_press





if( !function_exists( 'acf_util_reciprocate_relationship_fields' ) ) :
/**
 * Util function to handle all the reciprocal relationships
 */
function acf_util_reciprocate_relationship_fields( $key_a, $key_b, $value, $post_id, $field ){
...
endif; // acf_util_reciprocate_relationship_fields
