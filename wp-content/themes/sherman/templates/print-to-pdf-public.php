<?php
/*
Template Name: Print Itinerary to PDF
*/
/**
 * The template for printing a tour to pdf, for public.
 *
 * @package sherman
 */
...
if (get_post_status($tour_id) === 'draft') {
...
$html .= 'If you\'re not already working with a travel agent, DuVine can assist with the following reservations for up to three days before and after your tour. A fee of $75 per traveler will be applied.<br />
    <ul class="regular-list" style="margin-top: 10px;margin-bottom:10px;">
    <li>Pre and post-trip hotels in major cities, in addition to the first and last on-tour hotels</li>
    <li>Train travel</li>
...
Gratuities for DuVine guides are very much appreciated to thank them for exceptional service, support, and expertise. The industry standard is for each individual guest to tip 10-15% (U.S. tours) or 7.5-10% (all other tours) of their trip price at the end of the tour. Unless you want to tip separately, guides will divide tips among themselves. Guides graciously accept gratuities either in local currency or via <a href="https://paypal.com">PayPal</a>. We recommend that you plan ahead by bringing extra cash or visiting the ATM at the beginning of your trip, since ATMs are not always available near the last hotel of the tour.';
...
We believe bike travel should leave little behind. DuVine takes small measures to be greener—like eliminating single-use plastic water bottles, replacing paper maps with GPS, returning your pedals in cloth bags, and offering snacks in reusable containers rather than disposable plastic.';

$img = '<br /><br /><img src="'.get_template_directory().'/img/print-to-pdf/your-tour-details-img4.png'.'" style="width:100%;" />';
...
<ul style="width:40%;vertical-align:text-top;list-style-type:none;float:left;margin-top:0px;padding-left:0;font-size:11px;">
...
$html = $html.'<div style="padding:20px 0 0 0;">'; // image under grey column
$html = $html.'<img src="'.get_template_directory().'/img/print-to-pdf/group-selfie.png'.'" style="width:100%;" />';
