      ...
      return (
        (t.prototype.setup_triggers = function () {
          ...
          this.$triggers.on("click", function (t) {
            if (e(t.target).attr('class') !== 'tooltip light tooltipstered') {
              t.preventDefault(),
                e(this)
                  .toggleClass("active")
                  .parent()
  ...
  (function (t, e, i) {
      ...
      n()
        ? e(document).scrollTop() > 100
          ? (e("body").addClass("scrolling"),
            e(".utilitynav").prependTo(".mobilenav__mainpane"))
          : (e("body").removeClass("scrolling"),
            e(".utilitynav").fadeIn(400),
            e(".utilitynav").insertAfter(".searchnav"))
        : (e("body").removeClass("scrolling"),
          e(".utilitynav").insertAfter(".searchnav").fadeIn(400));
    }
    function g() {
    ...
    (t.init = function () {
      ...
      if (window.location.pathname === "/why-duvine/loyalty/") {
        e('.loyalty-club__column').eq(0).find('.accordion__content').find('li').each(function (i, el) {
          let element = e(el), height = parseInt(element.css('height'));
          if (height > 90) {
            height = parseInt(element.children('.bottom-text__copy').css('height'));
            element.css('height', height + "px");
          }
        });
        e('.loyalty-club__column').eq(1).find('.accordion__content').find('li').each(function (i, el) {
          let element = e(el), height = parseInt(e('.loyalty-club__column').eq(0).find("." + element[0].classList[0]).css('height'));
          element.css('height', height + "px");
